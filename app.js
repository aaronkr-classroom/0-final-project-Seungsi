...
const pagesController = require("./controllers/pagesController"),
  ...
  spaceController = require("./controllers/spaceController"),
...
mongoose.connect("mongodb+srv://seungsi:tmdrlqlqjs0911@ut-node.8n0krvz.mongodb.net/?retryWrites=true&w=majority&appName=ut-node", {
...
router.get(
  "/space",
  spaceController.index,
  spaceController.indexView
); // index 라우트 생성
router.get("/space/new", spaceController.new); // 생성 폼을 보기 위한 요청 처리
router.post(
  "/space/create",
  spaceController.create,
  spaceController.redirectView
); // 생성 폼에서 받아온 데이터의 처리와 결과를 사용자 보기 페이지에 보여주기
router.get(
  "/space/:id",
  spaceController.show,
  spaceController.showView
);
router.get("/space/:id/edit", spaceController.edit); // viewing을 처리하기 위한 라우트 추가
router.put(
  "/space/:id/update",
